...
- [ ] Complete the remaining human and external gates listed in `docs/submission/remaining-work.md`. The goal stopped at Michael's request on 2026-07-15 with the repository safe and the remaining work explicitly unclaimed.
