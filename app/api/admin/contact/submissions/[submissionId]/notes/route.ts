...
import { addContactSubmissionNote } from "@/db/contact-write.ts";
import {
  readJsonMutation,
...
export async function POST(
  ...
  return runApiRoute("admin.contact_note_failed", async (requestId) => {
    ...
    const result = await addContactSubmissionNote(env.DB, submissionId, input, {
