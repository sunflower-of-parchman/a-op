...
import { publishVideo } from "@/db/video-write.ts";
import {
  readJsonMutation,
...
export async function POST(
  ...
  return runApiRoute("admin.video_publish_failed", async (requestId) => {
    ...
    const result = await publishVideo(env.DB, slug, expectedRevision, {
