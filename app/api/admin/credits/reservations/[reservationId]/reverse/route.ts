...
import { reverseConsumedCreditReservation } from "@/db/credit-ledger-write.ts";
import {
  readJsonMutation,
...
export async function POST(
  ...
  return runApiRoute(
    "admin.credit_reservation_reverse_failed",
    async (requestId) => {
      ...
      const result = await reverseConsumedCreditReservation(
        env.DB,
