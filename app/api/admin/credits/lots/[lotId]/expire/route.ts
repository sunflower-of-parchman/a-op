...
import { expireCreditGrantLot } from "@/db/credit-ledger-write.ts";
import {
  readJsonMutation,
...
export async function POST(
  ...
  return runApiRoute("admin.credit_lot_expire_failed", async (requestId) => {
    ...
    const result = await expireCreditGrantLot(
      env.DB,
