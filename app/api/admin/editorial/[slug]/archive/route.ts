...
import { archiveEditorialPost } from "@/db/editorial-write.ts";
import {
  readJsonMutation,
...
export async function POST(
  ...
  return runApiRoute("admin.editorial_archive_failed", async (requestId) => {
    ...
    const result = await archiveEditorialPost(env.DB, slug, expectedRevision, {
