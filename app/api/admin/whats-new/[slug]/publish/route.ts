...
import { publishUpdate } from "@/db/updates-write.ts";
import {
  readJsonMutation,
...
export async function POST(
  ...
  return runApiRoute("admin.update_publish_failed", async (requestId) => {
    ...
    const result = await publishUpdate(env.DB, slug, expectedRevision, {
