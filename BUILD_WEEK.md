...
| Demo and judging access         | Local route verified; isolated provider resources created; all 11 reviewed Supabase migrations applied with exact remote parity, normalized type parity, and clean linked lint; fixtures, deployment, and private test access remain separately gated |
