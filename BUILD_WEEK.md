...
| Demo and judging access         | Local route verified; isolated provider resources created; approved Supabase link and 11-migration dry run passed with 0 remote migrations; application, deployment, and private test access remain separately gated |
